...
export default function Signin() {
  ...
  return (
    <div className="flex justify-center h-screen">
      <div
        className="md:w-1/2 xs:w-full flex items-center justify-center flex-col relative"
            ...
            >
              <SwiperSlide>
                <div className="flex justify-between flex-col items-center w-full">
                  <div className="mb-5 md:w-1/3 xs:w-5/6">
                    <input
                      type="email"
                      name="email"
                  ...
                  <button
                    type="submit"
                    className="btn btn-primary md:w-1/3 xs:w-5/6 capitalize"
                    onClick={() => {
              ...
              <SwiperSlide>
                <div className="flex justify-between flex-col items-center w-full">
                  <div className="mb-5 xs:mt-5 md:w-1/3 xs:w-5/6">
                    <input
                      name="name"
                      onChange={formik.handleChange}
                      onBlur={formik.handleBlur}
                  ...
                  <button
                    type="submit"
                    className="btn btn-primary capitalize md:w-1/3 xs:w-5/6"
                    onClick={() => {
                      setProgress(progress + 50);
                      swiperRef.current.swiper.slideNext();
                    }}
